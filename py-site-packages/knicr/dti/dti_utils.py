...
class knicrTBSS():
    ...
    def tbss_4_prestats(self, **kwargs):
        ...
        tbss_skeleton = fsl.TractSkeleton(threshold=threshold, distance_map=os.path.join(self.statsDir, 'mean_FA_skeleton_mask_dst.nii.gz'), data_file=self.merged4d, projected_data=final4d, in_file=os.path.join(self.statsDir, 'mean_FA.nii.gz'))
