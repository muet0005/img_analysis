...
cfg.write(cfg_str + '\n')
cfg_str = 'set bvalfile = ' + os.path.join(dtroot, subjid + '/dti_idc_' + subjid + '.tracula.bval')
cfg.write(cfg_str + '\n')
cfg_str = 'set bvecfile = ' + os.path.join(dtroot, subjid + '/dti_idc_' + subjid + '.tracula.bvec')
cfg.write(cfg_str + '\n')
cfg_str = 'set nb0 = 3'
cfg.write(cfg_str + '\n')
