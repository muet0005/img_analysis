...
xnatFile = open('/Users/rmuetzel/Desktop/xnat_mrsessions_28jan2014.csv', 'r')
oFile = open('/Users/rmuetzel/Desktop/GenR_F9_MRI_jan_28_2013_FORMATTED.csv', 'w')
...
print 'Found: ', len(seq_dict.keys()), '  Rnumbers in XNAT...'
csv_data = []
headers = ['rnumber']
