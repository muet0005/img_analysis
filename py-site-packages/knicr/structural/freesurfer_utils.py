        ...
        for i in kwargs.keys():
            if i == 'glmdir':
                ...
                if not isinstance(contrasts, list):
                    ...
                    sys.exit(0)        
        glm = freesurfer.GLMFit(in_file = self.data, contrast = self.contrasts, design = self.fsgdMat, surf = True, subject_id = self.template, hemi = self.hemi, cortex = True, glm_dir = glmdir)
        glm.run()
