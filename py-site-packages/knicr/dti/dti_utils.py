...
class knicrTBSS():
    ...
    def tbss_4_prestats(self, **kwargs):
        ...
        data_file=self.merged4d, projected_data=final4d, in_file=os.path.join(self.statsDir, 'mean_FA.nii.gz'), project_data=True, use_cingulum_mask=False, search_mask_file=cing_file)
