...
class gen_mat():
    ...
    def two_grpT_oneCovar_MainFx(self, **kwargs):
        ...
        mat_line = ['/NumWaves       3']
        mat.append(mat_line)
        mat_line = ['/NumPoints      '+ str(len(data))]
        mat.append(mat_line)
        mat_line = ['/PPheights              1.000000e+00    1.000000e+00    1.000000e+00']
        mat.append(mat_line)
        mat_line = ['/Matrix']
        mat.append(mat_line)        
        for i in range(0, len(data)):
            ...
            if demean:
                mat_line = [1, int(grp_dict[int(data[i][1])][0]), int(grp_dict[int(data[i][1])][1]), data[i][2]-col2mean]
            else:
                mat_line = [1, int(grp_dict[int(data[i][1])][0]), int(grp_dict[int(data[i][1])][1]), data[i][2]]
            mat.append(mat_line)
    ...
    def two_grpT_oneCovar_Intx(self, **kwargs):
        ...
        mat_line = ['/NumPoints      '+ str(len(data))]
        mat.append(mat_line)
        mat_line = ['/PPheights              1.000000e+00    1.000000e+00    1.000000e+00   1.000000e+00 ']
        mat.append(mat_line)
        mat_line = ['/Matrix']
        mat.append(mat_line)        
        for i in range(0, len(data)):
            ...
            #mat line: [grp_var, grp0, grp1, covar]
            if demean:
                mat_line = [1, int(grp_dict[int(data[i][1])][0]), int(grp_dict[int(data[i][1])][1]), (data[i][2]-col2mean)*int(grp_dict[int(data[i][1])][0])+0, (data[i][2]-col2mean)*int(grp_dict[int(data[i][1])][1])+0]
            else:
                mat_line = [1, int(grp_dict[int(data[i][1])][0]), int(grp_dict[int(data[i][1])][1]), (data[i][2])*int(grp_dict[int(data[i][1])][0])+0, (data[i][2])*int(grp_dict[int(data[i][1])][1])+0]
            mat.append(mat_line)
        print 'Writing out mat file...' 
        oFile = open(self.outfile, 'w')
        csv_writer = csv.writer(oFile, delimiter = ' ')
    ...
    def two_grpT_twoCovar_MainFx(self, **kwargs):
        ...
        for i in range(0, len(data)):
            ...
            #mat line: [grp_var, grp0, grp1, covar]
            if demean:
                mat_line = [1, int(grp_dict[int(data[i][1])][0]), int(grp_dict[int(data[i][1])][1]), data[i][2]-col2mean, data[i][3]-col3mean]
            else:    
                mat_line = [1, int(grp_dict[int(data[i][1])][0]), int(grp_dict[int(data[i][1])][1]), data[i][2], data[i][3]]
            mat.append(mat_line)
        print 'Writing out mat file...' 
        oFile = open(self.outfile, 'w')
        csv_writer = csv.writer(oFile, delimiter = ' ')
    ...
    def two_grpT_twoCovar_Intx(self, **kwargs):
        ...
        mat_line = ['/NumPoints      '+ str(len(data))]
        mat.append(mat_line)
        mat_line = ['/PPheights              1.000000e+00    1.000000e+00    1.000000e+00   1.000000e+00   1.000000e+00']
        mat.append(mat_line)
        mat_line = ['/Matrix']
        mat.append(mat_line)        
        for i in range(0, len(data)):
            ...
            if demean:
                if covar_inter == 1:
                    mat_line = [1, int(grp_dict[int(data[i][1])][0]), int(grp_dict[int(data[i][1])][1]), (data[i][2]-col2mean)*int(grp_dict[int(data[i][1])][0])+0, (data[i][2]-col2mean)*int(grp_dict[int(data[i][1])][1])+0, data[i][3]-col3mean]
                else:
                    mat_line = [1, int(grp_dict[int(data[i][1])][0]), int(grp_dict[int(data[i][1])][1]), data[i][2]-col2mean, (data[i][3]-col3mean)*int(grp_dict[int(data[i][1])][0])+0, (data[i][3]-col3mean)*int(grp_dict[int(data[i][1])][1])+0]
            else:
                if covar_inter == 1:
                    mat_line = [1, int(grp_dict[int(data[i][1])][0]), int(grp_dict[int(data[i][1])][1]), (data[i][2])*int(grp_dict[int(data[i][1])][0])+0, (data[i][2])*int(grp_dict[int(data[i][1])][1])+0, data[i][3]]
                else:
                    mat_line = [1, int(grp_dict[int(data[i][1])][0]), int(grp_dict[int(data[i][1])][1]), data[i][2], (data[i][3])*int(grp_dict[int(data[i][1])][0])+0, (data[i][3])*int(grp_dict[int(data[i][1])][1])+0]
            mat.append(mat_line)
        print 'Writing out mat file...' 
        oFile = open(self.outfile, 'w')
        csv_writer = csv.writer(oFile, delimiter = ' ')
