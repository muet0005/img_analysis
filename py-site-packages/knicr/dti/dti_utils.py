...
class knicrDTIprep():
    ...
    def fit_restore(self):
        ...
        fslmaths = fsl.maths.ApplyMask(in_file=self.data, out_file=dwi_masked,  output_type='NIFTI_GZ')
        fslmaths.run()
        write_log(fslmaths.cmdline, logFile)
        ...
        if not os.path.exists(restore_tensor):
            ...
            modelFit = camino.ModelFit(in_file=dwi_camino, model='restore', scheme_file=bvec_camino, sigma=sigma, out_file=restore_tensor, ignore_exception=True)
            modelFit.run()
