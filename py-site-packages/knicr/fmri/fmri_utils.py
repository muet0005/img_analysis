...
class gen_mat():
    ...
    def two_grpT_oneCovar_MainFx(self):
        grp_dict = {0: [1,0], 1: [0,1]}
        data = self.read_infile()
        col2mean = np.mean(np.transpose(data)[2])
        print 'Demeaning cov1 with mean: ', col2mean
        mat = []
        mat_line = ['/NumWaves       3']
        mat.append(mat_line)
        mat_line = ['/NumPoints      '+ str(len(data)-1)]
        mat.append(mat_line)
    ...
    def two_grpT_oneCovar_Intx(self):
        grp_dict = {0: [1,0], 1: [0,1]}
        data = self.read_infile()
        col2mean = np.mean(np.transpose(data)[2])
        print 'Demeaning cov1 with mean: ', col2mean
    ...
    def two_grpT_twoCovar_MainFx(self):
        grp_dict = {0: [1,0], 1: [0,1]}
        data = self.read_infile()
        col2mean = np.mean(np.transpose(data)[2])
        print 'Demeaning cov1 with mean: ', col2mean
        col3mean = np.mean(np.transpose(data)[3])
        print 'Demeaning cov2 with mean: ', col3mean
        mat = []
        mat_line = ['/NumWaves       4']
        mat.append(mat_line)
        mat_line = ['/NumPoints      '+ str(len(data)-1)]
