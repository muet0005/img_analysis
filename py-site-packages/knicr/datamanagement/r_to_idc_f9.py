...
class cvtRtoIDC():
    def __init__(self, **kwargs):
        ...
        self.baseName = '.Ryan_MRIConversion_March2013-March2015_nomis'
    ...
    def readIdcLink(self):
        ...
        for m in tar.getmembers():
            ...
            #added a section on UTF-8 signature because spss outputs that terd
            content = csv.reader(f.readlines().decode("utf-8-sig"), delimiter=',')
