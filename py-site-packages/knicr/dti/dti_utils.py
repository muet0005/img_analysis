...
class knicrDTIprep():
    ...
    def resample_dti(self):
        oFile = self.dwi.replace('.nii.gz', '_2.5mm.nii.gz')
    ...
    def extract_autoptx_stats(self, tblroot, subjid, **kwargs):
        ...
        *Assumes knicrAutoPtx has been run, 
        ...
        Optional inputs:   
                            ...
                            stats       ---> default = [wavg], which is the weighted average of the normalized path distr.
                                        ---> list type
