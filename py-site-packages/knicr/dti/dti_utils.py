...
class knicrTBSS():
    ...
    def tbss_4_prestats(self, **kwargs):
        ...
        distance_map=os.path.join(self.statsDir, 'mean_FA_skeleton_mask_dst.nii.gz'), search_mask_file=cing_file, data_file=self.merged4d, projected_data=final4d, use_cingulum_mask=False)
