    ...
    def tbss_1_preproc(self, subject, **kwargs):
        ...
        if not os.path.exists(self.mask):
            ...
            if tbss_preproc_default:
                ...
                fslmaths = fsl.ImageMaths(in_file=self.nodif_brain_mask, op_string='-fmean -kernel gauss 4 -ero -bin', out_file=self.mask, output_type='NIFTI_GZ', out_data_type='float')
            fslmaths.run()
            write_log(fslmaths.cmdline, logFile)
