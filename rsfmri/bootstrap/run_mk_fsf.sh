...
python /home/genr/software/bitbucket/lisa/rsfmri/bootstrap/mk_fsf_files.py -f $TMPDIR/rmuetzel/rsfmri -m ${FSLDIR}/data/knicr166_T1_1mm_brain.nii.gz -s ${idc} -o outdir_sfix --t1 $TMPDIR/t1/t1_idc_${idc}_0.9mm.nii.gz --config ${config}
