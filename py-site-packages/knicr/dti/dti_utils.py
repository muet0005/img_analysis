...
class knicrDTIprep():
    ...
    def fit_restore(self):
        ...
        if not os.path.exists(restore_tensor):
            ...
            modelFit = camino.ModelFit(in_file=dwi_camino, model='restore', scheme_file=bvec_camino, bgthresh=1, outlier=outlier,sigma=sigma, out_file=restore_tensor, ignore_exception=True)
            modelFit.run()
